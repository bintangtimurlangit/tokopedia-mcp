...
1. Use [GitHub private vulnerability reporting](https://github.com/bintangtimuralngit/tokopedia-mcp/security/advisories/new) if it is enabled for this repository, **or**
